    ...
    <table class="table-bordered" width=100%>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('Voir'), ['controller' => 'Factures', 'action' => 'clientes', $client->id]) ?>
                    <?php
...
<nav class="large-2 medium-4 columns" id="actions-sidebar" align="right">
        <div class="btn btn-xs"><?= $this->Html->link(__('Nouveau Client'), ['action' => 'add']) ?></div> &nbsp; &nbsp;&nbsp; &nbsp;
        <div class="btn btn-xs"><?= $this->Html->link(__('Aperçu'), ['controller' => 'Clients', 'action' => 'liste']) ?></div>
</nav>
</div>
