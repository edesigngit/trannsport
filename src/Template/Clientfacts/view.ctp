...
<center><img src='/transport/img/logo2.bmp' border=1 width=60% height=10%></center>
<div class="facture view large-5 medium-8 columns content">
    <legend style="font-family:Times new roman; color:blue;"><center><b>Bon de Livraison</center>
...
<div>
  <hr>
        ...
        <table cellpadding="0" cellspacing="0" class="table-bordered" width=100% align=center>
