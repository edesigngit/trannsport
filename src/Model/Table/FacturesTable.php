 ...
 * Factures Model
 *
 * @property \Cake\ORM\Association\BelongsTo $Clientfacts
...
class FacturesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('libelles', 'create')
            ->notEmpty('libelles');
    ...
    {
        $rules->add($rules->existsIn(['clientfact_id'], 'Clientfacts'));
